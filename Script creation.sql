...
CREATE TABLE "T_LIGNE_FACTURES" ("LIF_ID"  PRIMARY KEY  NOT NULL , "FAC_ID"  NOT NULL , "LIF_QTE"  NOT NULL , "LIF_REMISE_POURCENT" , "LIF_REMISE_MONTANT" , "LIF_MONTANT"  NOT NULL , "LIF_TAUX_TVA"  NOT NULL  DEFAULT 19.6);
